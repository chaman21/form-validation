$(document).ready(function(){
    ...
    function check_username(){
        ...
        if(username_length < 3 || username_length > 20){
            $('#usernamevalidation').html('Username should be atleast 4 characters long');
            $('#usernamevalidation').css('color', 'red');
            $('#usernamevalidation').show();
            Error = false;
            return false;
    ...
    function check_password(){
        ...
        if(password_length < 8 || password_length > 20){
            $('#passwordvalidation').html('Password must be more than 8 characters');
            $('#passwordvalidation').css('color', 'red');
            $('#passwordvalidation').show();
            password_error = false;
            return false;
    ...
    function check_email(){
        ...
        if(email_length < 3 || email_length > 20){
            $('#emailvalidation').html('Email must be atleast 3 characters');
            $('#emailvalidation').css('color', 'red');
            $('#emailvalidation').show();
            Error = false;
            return false;
